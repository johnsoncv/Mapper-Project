...
static constexpr color WATER_BLUE(170, 218, 255);
static constexpr color LIGHT_BLUE(129, 212, 250);
static constexpr color PARK_GREEN(195, 236, 178);
static constexpr color SAND(255, 242, 175);
static constexpr color STRUCTURES(255, 242, 175);

static constexpr color HIGHWAY(246, 207, 101);
static constexpr color PRIMARY(255, 202, 40);
static constexpr color LIGHT_GRAY(241, 241, 241);
static constexpr color DARK_GRAY(213, 216, 219);
}
